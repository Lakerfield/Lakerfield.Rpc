...
- **System.Reactive**: Required by both WebSocket [client](https://github.com/Lakerfield/Lakerfield.Rpc/blob/main/src/Lakerfield.Rpc.WebSocketClient/Lakerfield.Rpc.WebSocketClient.csproj) and [server](https://github.com/Lakerfield/Lakerfield.Rpc/blob/main/src/Lakerfield.Rpc.WebSocketServer/Lakerfield.Rpc.WebSocketServer.csproj) for reactive message handling.
- **Microsoft.AspNetCore.App**: Framework reference for the [WebSocket server](https://github.com/Lakerfield/Lakerfield.Rpc/blob/main/src/Lakerfield.Rpc.WebSocketServer/Lakerfield.Rpc.WebSocketServer.csproj).
...
{
  // code is generated by sourcegenerator
}
```
...
> **Note:** A TCP-based transport is also supported via the `RpcClient`/`RpcServer` packages.
